...
class MatrixD {
  ...
  public MatrixD symm(){
    return (this.add(this.transposed())).mul(0.5);
  }


  public MatrixD antiSymm(){
    return (this.sub(this.transposed())).mul(0.5);
  }
  ...
  public boolean isAntiSymm(){
    return this.equals(this.transposed().mul(-1));
  }
  ...
  public static void test(MatrixD A, MatrixD B) {
    ...
    A.transposed().print("A.transposed()");
    B.transposed().print("B.transposed()");
